...
//                Color c = new Color(pixel[w+h*width]);
            ...
            for (int i = 0; i < arrayAnalyzer.getClusters().size(); i++) {
                ...
                if (lookOnLeft) {
                    targetHot = targetHot || arrayAnalyzer.getClusters().get(i).isGoalOnLeft();
                } else {
                    targetHot = targetHot || arrayAnalyzer.getClusters().get(i).isGoalOnRight();
                }
